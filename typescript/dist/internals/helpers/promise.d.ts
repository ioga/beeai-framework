...
declare function toAsyncGenerator<T>(promise: T): AsyncGenerator<Awaited<T>>;

export { type EmitterToGeneratorFn, LazyPromise, arrayFromAsync, asyncExecute, asyncProperties, emitterToGenerator, executeSequentially, isPromiseLike, safeExecute, signalRace, toAsyncGenerator };
