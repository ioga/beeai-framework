import { Primitive } from './helpers/guards.cjs';
...
type MergeArrays<A extends any[], B extends any[]> = A extends [] ? B : B extends [] ? A : [MergeElements<Head<A>, Head<B>>, ...MergeArrays<Tail<A>, Tail<B>>];
type MergeFunctions<A extends AnyFn, B extends AnyFn> = (...args: MergeArrays<Parameters<A>, Parameters<B>>) => MergeElements<ReturnType<B>, ReturnType<A>>;
type WithoutLast<T> = T extends [...infer A, any] ? A : [];

export { type AbstractClassConstructor, type AbstractConstructable, type AnyConstructable, type AnyFn, type AnyVoid, type ArrayKeys, type Class, type ClassConstructor, type Common, type Constructable, type Constructor, type EmptyObject, type Enum, type EnumFromUnion, type EnumLowerCaseValue, type EnumValue, type ExcludeNonStringIndex, type Head, type MergeArrays, type MergeFunctions, type NamedFunction, type NoPromise, type NonEmptyArray, type NonUndefined, type ObjectLike, type OmitEmpty, type OmitPrivateKeys, type OmitType, type OneOf, type OptionalExcept, type PlainObject, type PromiseOrPlain, type RequiredAll, type RequiredExcept, type RequiredNested, type Tail, type TypedFn, type Unwrap, type ValueOf, type WithoutLast, type XOR, narrowTo };
