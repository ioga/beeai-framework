...
var opentelemetry__default = /*#__PURE__*/_interopDefault(opentelemetry);

var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });
const tracer = opentelemetry__default.default.trace.getTracer("beeai-framework", version_cjs.Version);
const activeTracesMap = /* @__PURE__ */ new Map();
function buildSpansForParent({ spans, parentId, traceId }) {
...
function buildTraceTree({ prompt, history, generatedMessage, spans, traceId, version, runErrorSpanKey, startTime, endTime, source }) {
  tracer.startActiveSpan(`beeai-framework-${source}-${traceId}`, {
    // custom start time
    startTime,
...
exports.activeTracesMap = activeTracesMap;
