...
class GraniteRunner extends runner_cjs.DefaultRunner {
  ...
  get defaultTemplates() {
    return {
      system: prompts_cjs.GraniteBeeSystemPrompt,
      assistant: prompts_cjs.GraniteBeeAssistantPrompt,
      user: prompts_cjs.GraniteBeeUserPrompt,
      schemaError: prompts_cjs.GraniteBeeSchemaErrorPrompt,
      toolNotFoundError: prompts_cjs.GraniteBeeToolNotFoundPrompt,
      toolError: prompts_cjs.GraniteBeeToolErrorPrompt,
      toolInputError: prompts_cjs.GraniteBeeToolInputErrorPrompt,
      // Note: These are from bee
      userEmpty: prompts_cjs$1.BeeUserEmptyPrompt,
      toolNoResultError: prompts_cjs$1.BeeToolNoResultsPrompt
    };
  }
  static {
    this.register();
