...
const GraniteBeeAssistantPrompt = prompts_cjs.BeeAssistantPrompt.fork((config) => {
...
const GraniteBeeSystemPrompt = prompts_cjs.BeeSystemPrompt.fork((config) => {
...
const GraniteBeeSchemaErrorPrompt = prompts_cjs.BeeSchemaErrorPrompt.fork((config) => {
...
const GraniteBeeUserPrompt = prompts_cjs.BeeUserPrompt.fork((config) => {
  config.template = `{{input}}`;
});
const GraniteBeeToolNotFoundPrompt = prompts_cjs.BeeToolNotFoundPrompt.fork((config) => {
  config.template = `Tool does not exist!
{{#tools.length}}
Use one of the following tools: {{#trim}}{{#tools}}{{name}},{{/tools}}{{/trim}}
{{/tools.length}}`;
});
const GraniteBeeToolErrorPrompt = prompts_cjs.BeeToolErrorPrompt.fork((config) => {
...
const GraniteBeeToolInputErrorPrompt = prompts_cjs.BeeToolInputErrorPrompt.fork((config) => {
...
exports.GraniteBeeAssistantPrompt = GraniteBeeAssistantPrompt;
exports.GraniteBeeSchemaErrorPrompt = GraniteBeeSchemaErrorPrompt;
exports.GraniteBeeSystemPrompt = GraniteBeeSystemPrompt;
exports.GraniteBeeToolErrorPrompt = GraniteBeeToolErrorPrompt;
exports.GraniteBeeToolInputErrorPrompt = GraniteBeeToolInputErrorPrompt;
exports.GraniteBeeToolNotFoundPrompt = GraniteBeeToolNotFoundPrompt;
exports.GraniteBeeUserPrompt = GraniteBeeUserPrompt;
