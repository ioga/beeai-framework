...
declare class LinePrefixParserError extends FrameworkError {
    isFatal: boolean;
    isRetryable: boolean;
    readonly context: Context;
    readonly reason: ValueOf<typeof LinePrefixParserError.Reason>;
    static Reason: {
        readonly NoDataReceived: "NoDataReceived";
        readonly InvalidTransition: "InvalidTransition";
        readonly NotStartNode: "NotStartNode";
        readonly NotEndNode: "NotEndNode";
        readonly AlreadyCompleted: "AlreadyCompleted";
