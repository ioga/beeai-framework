...
class Serializer {
  ...
  static async serialize(rawData) {
    ...
    const toSerializable = /* @__PURE__ */ __name(async (rawValue) => {
      ...
      const snapshot = isSelfRef ? utils_cjs.SerializerSelfRefIdentifier : await factory.toPlain(rawValue);
    ...
    await utils_cjs.traverseObject(root, async ({ value, path }) => {
  ...
  static async deserializeWithMeta(raw, extraClasses) {
    ...
    const toDeserialize = /* @__PURE__ */ __name(async (contentRaw) => {
      if (utils_cjs.isSerializerNode(contentRaw)) {
        ...
        const traverseNested = /* @__PURE__ */ __name(async () => {
    ...
    await utils_cjs.traverseObject(root, async ({ value: contentRaw, path }) => {
...
Serializer.register(promiseBasedTask.Task, {
  ...
  updateInstance: /* @__PURE__ */ __name(async (instance, value) => {
