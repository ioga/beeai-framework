import { SerializableClass, Serializable } from './internals/serializable.js';
import { ClassConstructor, NamedFunction, AnyFn, AnyConstructable } from './internals/types.js';
...
declare class ClassConstructorPlaceholder {
}
...
declare function traverseObject(obj: unknown, handler: TraverseObjectFn, stopFn?: (_obj: unknown) => boolean): Promise<void>;
...
declare function deepCopy<T>(source: T): Promise<T>;
type Bounded = {
    name: string;
    value: any;
} | AnyConstructable;
